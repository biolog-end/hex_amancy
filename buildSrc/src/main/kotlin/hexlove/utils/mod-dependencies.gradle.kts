...
abstract class HexloveModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexloveModDependenciesExtension>("hexloveModDependencies")
