...
<p align="center">
  ...
  <img alt="Fabric and Forge" src="https://img.shields.io/badge/loader-Fabric%20%7C%20Forge-blue">
...
An addon for **Hex Casting** about attachment, jealousy, vows, and what a world does when you have been kind to it.
...
A charmed creature is not a puppet.

It goes to the one it loves. It steps into a fight that one is actually in, and drops the grudge when the chase carries it too far from home. It cannot bring itself to land a deliberate blow on the one it loves — and neither can that creature's rivals, its owner's pets, or a spouse.

It will not protect anyone from gravity, lava, a creeper or a stray arrow. The world is still the world.
...
**Blinding Jealousy** — sets one creature to guard another and resent everybody else. A creature with no way to fight is given one for as long as it lasts.

**Siren's Song** — draws a creature towards whoever called it. Players are drawn too, and cannot look away from the voice.

**Phantom Ideal** — a transparent rose image of the caster, standing where you put it. Every unbound creature nearby forgets its target and walks towards it. It is no body to strike, and it cannot be moved.

**Pheromone Mist** — a sphere of pale pink perfume. Hostile creatures inside it go quiet, until the first one of them is hurt.

**Heartbreak** — the only way out of a charm, your own included.

**Soulbind** — wakes a ring and writes a player's name into it.
...
**Heart's Purification** — measures the combined usable strength of everything that loves a given creature.
...
A **Soulbound Ring** is a personal talisman. Woken by Soulbind, it takes your name and a colour of its own.
...
Somewhere past all of that is an altar that listens to kindness done in the world.
...
Everything above is documented in the Hex Casting book itself — one spread per pattern, plus entries on the keepsakes, the vows, the Chimera and the altar. Available in **English** and **Russian**.

There is also a web version: **[read the book online](https://biolog-end.github.io/hex_amancy/v/latest/main/en_us/)**.

Eighteen advancements track the path from your first amethyst flower to the Author's sealed legacy.
...
| Required | Hex Casting 0.11.3, Architectury API, Cloth Config |
| Fabric also needs | Fabric API, Fabric Language Kotlin |
| Forge also needs | Kotlin for Forge |
| Optional | Carry On, Trinkets (Fabric), Curios (Forge) |
